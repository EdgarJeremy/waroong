...
const styles = {
    container: { margin: 4, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', borderColor: '#2ecc71', borderWidth: 2, padding: 5, borderRadius: 10 },
}
    ...
    render() {
        ...
        return (
            <View style={[styles.container, { borderColor: propTintColor }, propContainerStyles]}>
                <Icon name={iconName} size={20} color={propTintColor} /><Text style={{ color: propTintColor }}> {propText}</Text>
            </View>
        );
    }
