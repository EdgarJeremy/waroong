    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <ScrollView>
                    <View style={{ justifyContent: 'center', alignItems: 'center', elevation: 1, backgroundColor: '#f1f2f6', padding: 50, paddingBottom: 65 }}>
                        ...
                        />
                        <Text style={{ marginBottom: 5, textDecorationLine: 'underline', fontWeight: 'bold' }}>{user.email}</Text>
                    </View>
